...
export class MainPageComponent implements OnInit {
  ...
  @Input() user:User={name:'',email:'',phone:'',url:'Poulomi Palazzo'};
  constructor(private element: ElementRef,private formbuilder:FormBuilder,private http:HttpClient,private userService: UserService,private ipAdd:IpServiceService,public router:Router) { 
    this.Createform();
  }
